            ...
            <div className="grid grid-cols-6 gap-6 rounded mb-6 border-2 px-2 py-2">
                ...
                <div className="col-span-6 sm:col-span-3 lg:col-span-1 ">
                    <FormField title="Type" className="grow">
                        <ChoiceEditor
                            ...
                            onChange={val => setUpdateSubscriptionData({...updateSubscriptionData, type: val})}
                ...
                <div className="col-span-6 sm:col-span-3 lg:col-span-1 ">
                    <FormField title="Document" className="grow">
                        <DocumentSelector disabled={true} value={updateSubscriptionData?.documentId}
                ...
                <div className="col-span-6 sm:col-span-3 lg:col-span-1 ">
                    <FormField title="Partner" className="grow">
                        <PartnerSelector disabled={true} value={updateSubscriptionData?.partnerId}
                                         onChange={val => setUpdateSubscriptionData({
                                             ...updateSubscriptionData,
                                             partnerId: val
                                         })}/>
