            ...
            <tbody>
            {
                data.map((i) => (
                    <tr key={i.id} className="bg-white border-b">
                        ...
                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <button onClick={() => navigate(`${i.id}`)} type="button" className="text-white bg-blue-600 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
