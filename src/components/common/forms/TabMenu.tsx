...
const Component: React.FC<Props> = ({className = "", title, children, ...htmlProps}) => (
    <div {...htmlProps}
         className={classes("flex flex-nowrap items-center relative first:ml-0 ml-4 text-sm font-light text-gray-400 group focus-within:shadow-b-2 focus-within:shadow-blue-400 focus-within:hover:shadow-blue-400 focus-within:hover:text-gray-400 hover:text-gray-500 hover:shadow-b-2 hover:shadow-gray-400 cursor-pointer", className)}>
