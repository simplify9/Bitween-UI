import {KeyValuePair, OptionType, StartupValue} from "src/types/common";
...
type Props = Omit<React.JSX.IntrinsicElements['input'], "onChange"> & {
    ...
    startupValueMeta?: Record<string, StartupValue>;
}
                    ...
                    <div className="flex flex-col gap-5">
                        {revealValue ? (
                            ...
                            <>
                                ...
                                {startupValueMeta?.[newKeyValue.key]?.description && (
