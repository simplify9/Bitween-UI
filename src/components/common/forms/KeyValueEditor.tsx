...
const Component: React.FC<Props> = ({
    ...
    return (
        <div>
                    ...
                    <div
                        ...
                        {!valueAutoGeneratedOnAdd && <div className="mt-4">
                            <FormField title={valueLabel ?? ""} className="grow">
                                ...
                                <textarea className={"w-full border rounded-md shadow p-1"} onChange={(t) => setNewKeyValue({
                                    ...newKeyValue,
                                    value: t.target.value
                                })} value={newKeyValue?.value}> </textarea>
            ...
            <table className="appearance-none max-w-100">
                    ...
                    values && values.length > 0 ?
                        values?.map((i) => (
                            <tr key={`${i.key}_${i.value}`} className="bg-white border-b">
                                ...
                                <td
                                    className="text-sm w-100 text-gray-900 font-light px-4 py-4">
                                    {i.value}
                                </td>
                                <td
