...
import {IDocument, UpdateDocument} from "../types/document";
        ...
        <div className="flex flex-col w-full px-8 py-10">
            <div className="justify-between w-full flex py-4">
                ...
                <div className={"flex gap-2"}>
                    ...
                    <Button onClick={deleteDocument} className="bg-red-600 hover:bg-red-500 text-white py-2 px-4 rounded">
                        Delete
                    </Button>
            ...
            <div className="relative z-0 w-full mb-6 group">
                <FormField title="Name" className="grow">
                    <TextEditor disabled={true} value={updateDocumentData?.name} onChange={(t) => setUpdateDocumentData({
                        ...updateDocumentData,
                        name: t
                    })}/>
                </FormField>
            ...
            <div className="relative z-0 w-full mb-6 group flex">
                <FormField title="Bus Enabled" className=" w-40">
                    <CheckBoxEditor  checked={updateDocumentData.busEnabled} onChange={(t) => setUpdateDocumentData({
                        ...updateDocumentData,
                        busEnabled: t
                    })}/>
                </FormField>
                <FormField title="Bus message type name" className="grow">
                    <TextEditor disabled={!updateDocumentData.busEnabled}  value={updateDocumentData?.busMessageTypeName} onChange={(t) => setUpdateDocumentData({
                        ...updateDocumentData,
            ...
            <div className="relative z-0 w-full mb-6 group flex w-full">
                ...
                <KeyValueEditor values={updateDocumentData?.promotedProperties} title={'Promoted Properties'}
                    keyLabel={"Friendly Name"} valueLabel={"Json Path"}
                                onAdd={addPromotedProperty} onRemove={removePromotedProperty} addLabel={"Add New Promoted Property"}
                />
