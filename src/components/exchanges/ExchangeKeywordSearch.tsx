        ...
        <form noValidate className="flex w-full px-4 py-8" onSubmit={handleFind}>
            <div className="flex flex-wrap items-end -mx-3 mb-2 space-x-4 w-full">
                <FormField title="Keyword(s)" className="grow">
                    <TextEditor placeholder="Type in any related keyword or identifier..." value={value}
                                onChange={onChange}/>
                </FormField>
                <button
                    type="submit"
                    className="block appearance-none border bg-primary-900 hover:bg-primary-900 text-white py-2 px-4 rounded drop-shadow-sm focus:drop-shadow-lg focus:outline-none">
                    Find
                </button>
            </div>
        </form>
