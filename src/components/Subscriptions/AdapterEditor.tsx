...
const AdapterEditor:React.FC<Props> = ({ value, onChange,type,title,props, onPropsChange }) => {
    ...
    return (
        <>
            ...
            <KeyValueEditor values={props} title={'Properties'}
                            ...
                            onAdd={onAdd} onRemove={onRemove} addLabel={"Add or edit"}
                            keyOptions={adapterPropsOptions}
            />
            </div>
