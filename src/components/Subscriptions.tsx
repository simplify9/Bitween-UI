...
} from "./common/DataListViewSettingsEditor";
...
const Component = () => {
  ...
  const [openModal, setOpenModal] = useState<"NONE" | "ADD" | "DUPLICATE">(
    "NONE"
  );
  ...
  const handleViewOptionsChange = useCallback(
    (viewOptions: DataListViewSettings) => {
      const newSpecs = {
        ...findSpecs,
    ...
    <>
      ...
      {openModal === "ADD" && (
        <CreateNewSubscription
          onAdd={onClickCreateSubscription}
