...
export default (props:Props) => {
    ...
    return (
        ...
        <div className="flex flex-col w-full px-8 py-4">
            ...
            <PartnerFinderPanel value={findSpecs} onChange={setFindSpecs} onFindRequested={handleFindRequested} />
            ...
            {creatingOn && <CreateNewPartner onAdd={createPartner} onClose={() => setCreatingOn(false)} />}
        </>
    )
}
