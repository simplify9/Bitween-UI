...
const Component = () => {
    ...
    return (
        <div className="flex flex-col w-full px-8 py-5">
            ...
            <div className="relative z-0 w-full mb-6 group flex w-full justify-between">
            ...
            <div className="relative z-0 w-full pt-3 mb-6 group flex w-full justify-between">

                
                <div className="w-full ">
                    <div className="text-2xl w-full bg-gray-100 py-2 font-bold tracking-wide px-5 text-gray-700">Subscriptions</div>
