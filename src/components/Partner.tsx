...
const Component = () => {
    ...
    const updatePartner = async () => {
        ...
        if (res.succeeded) refreshPartner(id!);
    }
        ...
        <div className="flex flex-col w-full px-8 py-10">
            <div className="justify-between w-full flex py-4">
                ...
                <div className={"flex gap-2"}>
                    ...
                    <Button onClick={deletePartner} className="bg-red-600 hover:bg-red-500 text-white py-2 px-4 rounded">
                        Delete
                    </Button>
            ...
            <div className="relative z-0 w-full mb-6 group flex w-full">
                <div className="grid xl:grid-cols-2 xl:gap-6">
                    <KeyValueEditor values={updatePartnerData?.apiCredentials} title={'Api Credentials'}
                ...
                <div className="grid xl:grid-cols-2 xl:gap-6 pb-10">
                    <table className="appearance-none min-w-full">
                        <thead className="border-y bg-gray-50">
                        <div className="text-2xl font-bold tracking-wide px-5 text-gray-700">Subscriptions</div>
                        <tr>
