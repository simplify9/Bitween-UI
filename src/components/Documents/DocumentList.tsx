            ...
            <tbody>
            {
                data.map((i) => (
                    <tr key={i.id} className="bg-white border-b">
                        ...
                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                            <button onClick={() => navigate(`${i.id}`)} type="button" className="text-white bg-teal-600 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm  px-3 py-2.5 text-center inline-flex items-center  mr-2 mb-2">
                                <svg id="Layer_1" className="w-5 h-100" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110.61 122.88">
